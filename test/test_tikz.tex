...
\newcommand\embedaspictcom[1]{\tikz[baseline=-\the\dimexpr\fontdimen22\textfont2\relax]{\node[pict]{\mbox{#1}};}}
...
\begin{multi}{Multi}
\embedaspictcom{1}
\item[feedback={\embedaspictcom{2}}]* test \embedaspictenv{toast}
\item[feedback={\embedaspictenv{4}}] test \embedaspictcom{toast}
\end{multi}
