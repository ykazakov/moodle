...
\docsvlist{english,french,german,italian,spanish}% fully supported
\def\do#1{
\begin{otherlanguage}{#1}
...
\docsvlist{catalan,croatian,czech,danish,dutch,estonian,finnish,hungarian,
 icelandic,lithuanian,norsk,polish,portuguese,romanian,swedish,turkish}%foobar,
\end{quiz}
